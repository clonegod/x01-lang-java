...
class HttpInvoker {
    ...
    /** HTTP协议调用器配置 */
    private HttpInvokerConfig config;
     ...
     * @param method 请求方法
     */
    public HttpInvoker(String url, String method) {
        this.config = new HttpInvokerConfig();
     ...
     * @param params 参数
     */
    public HttpInvoker(String url, Map<String, String> params) {
        this.config = new HttpInvokerConfig();
        this.config.setUrl(url);
     ...
     * @param params 参数
     */
    public HttpInvoker(String url, String method, Map<String, String> params) {
        this.config = new HttpInvokerConfig();
        this.config.setUrl(url);
        this.config.setMethod(method);
        this.config.setParams(params);
     ...
     * @param config 配置
     */
    public HttpInvoker(HttpInvokerConfig config) {
        this.config = config;
    }
