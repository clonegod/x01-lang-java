 ...
 *  消息的确认应答模式分为以下4种：
 *  	AUTO_ACKNOWLEDGE	消息自动签收模式 
 *  	CLIENT_ACKNOWLEDGE	
 *  	DUPS_OK_ACKNOWLEDGE
 *  	SESSION_TRANSACTED
 */
public class P2PConsumerNoTransactedByAutoAcknowledge {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/** 创建非事务会话，并指定消息应答模式为：客户端自动签收 */
			session = conn.createSession(Boolean.FALSE, Session.AUTO_ACKNOWLEDGE); // 创建非事务会话，消息手动签收
