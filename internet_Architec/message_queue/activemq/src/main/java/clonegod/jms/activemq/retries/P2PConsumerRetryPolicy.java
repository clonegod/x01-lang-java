...
public class P2PConsumerRetryPolicy {
	...
	public static void main(String[] args) {
		...
		try {
			...
			policy.setBackOffMultiplier(2); // 倍数
			policy.setUseExponentialBackOff(true); // 开启衰减重试
			policy.setMaximumRedeliveries(5); // nextDelay=preDelay * 2
