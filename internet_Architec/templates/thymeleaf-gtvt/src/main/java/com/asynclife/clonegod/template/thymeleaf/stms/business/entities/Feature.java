 ...
 * =============================================================================
 */
package com.asynclife.clonegod.template.thymeleaf.stms.business.entities;



public enum Feature {
    
    SEEDSTARTER_SPECIFIC_SUBSTRATE("SEEDSTARTER_SPECIFIC_SUBSTRATE"), // 专用
    FERTILIZER("FERTILIZER"),  //化肥
    PH_CORRECTOR("PH_CORRECTOR"); //酸碱校正
