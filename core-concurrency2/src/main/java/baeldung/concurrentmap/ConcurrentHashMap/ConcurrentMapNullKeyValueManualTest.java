...
/**
 * ConcurrentMap 对null-key,null-value的限制。
 *
 */
public class ConcurrentMapNullKeyValueManualTest {
     ...
     * ConcurrentMap中大多数的API都不允许key或value为null
     */
    ...
    /**
     * for compute* and merge actions, the computed value can be null
     * 对于compute* and merge操作，value可以为null
     */
    @Test
