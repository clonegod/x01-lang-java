...
public class JBPM_FORK_JOIN_Test {
	...
	public void test01_DeployProcessDefinition() {
		...
		newDeploy.addResourceFromClasspath("process02.jpdl.xml")
			.setName("贷款审批流程2")
	...
	public void test03_StartProcessInstance() {
		...
		String processDefinitionKey = "forkjoin"; // 流程定义的key
		String processInstanceKey = "1000"; // 设置为业务对象的id-贷款申请对应业务对象的数据库id
	...
	public void test04_FindCurrentNodeByProcessInstance() {
		...
		// 流程实例的key
		String processInstanceId = "forkjoin.1000";
	...
	/**
	 * 查询我的任务，完成任务，提交给下一个人审批 - 技术部主管审批（会签）
	 */
	@Test
	public void test05_FindAndCompleteMyTask02_ForkJoin_1() {
		// 获取流程引擎对象
		ProcessEngineImpl engine = (ProcessEngineImpl) new Configuration()
				.setResource("jbpm.cfg.xml").buildProcessEngine();
		
		
		String assignee = "技术部主管";
	...
	/**
	 * 查询我的任务，完成任务，提交给下一个人审批 - 财务部主管审批（会签）
	 */
	@Test
	public void test05_FindAndCompleteMyTask02_ForkJoin_2() {
		// 获取流程引擎对象
		ProcessEngineImpl engine = (ProcessEngineImpl) new Configuration()
				.setResource("jbpm.cfg.xml").buildProcessEngine();
		
		
		String assignee = "财务部主管";
	...
	/**
	 * 查询我的任务，完成任务，提交给下一个人审批 - BOSS审批
	 */
	@Test
	public void test05_FindAndCompleteMyTask03() {
		// 获取流程引擎对象
		ProcessEngineImpl engine = (ProcessEngineImpl) new Configuration()
				.setResource("jbpm.cfg.xml").buildProcessEngine();
