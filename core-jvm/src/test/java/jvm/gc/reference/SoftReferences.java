...
// see: https://plumbr.eu/blog/garbage-collection/weak-soft-and-phantom-references-impact-on-gc
...
/**
 * each wrapped in a SoftReference object and may be garbage-collected if the memory becomes low.
 * */            
