...
import com.clonegod.unittest.junitparams.PersonMapper;
import com.clonegod.unittest.junitparams.PersonTest;
import com.clonegod.unittest.junitparams.PersonType;
...
//	}
	...
	@Test
	@Parameters
	public void wrapParamsWithConstructor(Person person) {
	}
...
//	}
	...
	public Object mixedParameters() {
		...
		return $($(booleanValue, primitiveArray, stringValue, stringArray));
	}

	@Test
	@Parameters(method = "mixedParameters")
	@TestCaseName("{0}, {1}, {2}, {3}")
	public void usageOfMultipleTypesOfParameters(boolean booleanValue, int[] primitiveArray, String stringValue,
			String[] stringArray) {
	}
